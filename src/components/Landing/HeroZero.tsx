      ...
      <div className="container relative z-10">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4 ml-10">
            ...
            With your <span className="text-[#6F07FB]">Company</span>, build <RotatingText
              texts={['Growth!', 'Success!', 'Vision!', 'Brand!']}
              mainClassName="px-2 sm:px-2 md:px-3 my-2 bg-[#6F07FB] w-fit text-white overflow-hidden py-0.5 sm:py-1 md:py-2  rounded-lg"
              staggerFrom={"last"}
              initial={{ y: "100%" }}
              animate={{ y: 0 }}
              exit={{ y: "-120%" }}
